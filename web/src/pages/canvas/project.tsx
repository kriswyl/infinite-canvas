...
function buildGenerationConfig(config: AiConfig, node: CanvasNodeData | undefined, mode: CanvasNodeGenerationMode): AiConfig {
    ...
    return {
        ...
        klingVersion: node?.metadata?.klingVersion || config.klingVersion || defaultConfig.klingVersion,
        klingVoice: node?.metadata?.klingVoice || config.klingVoice || defaultConfig.klingVoice,
