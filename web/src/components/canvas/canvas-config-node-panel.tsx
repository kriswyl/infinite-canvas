...
function buildNodeConfig(globalConfig: AiConfig, node: CanvasNodeData, mode: CanvasGenerationMode): AiConfig {
    ...
    return {
        ...
        klingVersion: node.metadata?.klingVersion || globalConfig.klingVersion || defaultConfig.klingVersion,
        klingVoice: node.metadata?.klingVoice || globalConfig.klingVoice || defaultConfig.klingVoice,
